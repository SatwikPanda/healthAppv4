...
('doctor@example.com', crypt('doctor123', gen_salt('bf')), 'doctor'),
('receptionist@example.com', crypt('receptionist123', gen_salt('bf')), 'receptionist');
...
BEGIN
    ...
    SELECT id INTO receptionist_user_id FROM users WHERE email = 'receptionist@example.com';

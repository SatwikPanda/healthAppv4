...
export default function CheckAppointment() {
  ...
  const handleSubmit = (e) => {
    ...
    if (reference === 'doctor@123') {
      ...
      // Here you would typically check the appointment status
      alert('Appointment status: Confirmed for your requested time.');
    }
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow rounded-lg p-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Check Appointment Status</h1>

  ...
  const notifications = [
    {
      id: 1,
      type: 'appointment',
      message: 'New appointment request from Sarah Parker for tomorrow at 2:00 PM',
      time: '10 minutes ago',
      isRead: false,
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-blue-600">Doctor Dashboard</span>
            </div>
            ...
            <div className="bg-white shadow rounded-lg p-4">
              <div className="space-y-4">
                ...
                <button
                  ...
                  className={"w-full text-left px-4 py-2 rounded-md " + 
                    (activeTab === 'prescriptions' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50')
                  }
                >
                  Prescriptions
                </button>
                ...
                <button
                  ...
                  className={"w-full text-left px-4 py-2 rounded-md " + 
                    (activeTab === 'leave' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50')
                  }
                >
                  Leave Management
                </button>
          ...
          <div className="lg:col-span-3">
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {[
                        ...
                        { name: 'Jane Smith', age: 32, lastVisit: '2024-12-30' },
                        { name: 'Mike Johnson', age: 28, lastVisit: '2025-01-02' },
                      ].map((patient, index) => (
                        <tr key={index}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <button className="text-blue-600 hover:text-blue-800">View Record</button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                  ...
                  {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day) => (
                    <div key={day} className="border rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-xs bg-blue-100 text-blue-800 rounded p-1">6 Appointments</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {activeTab === 'prescriptions' && (
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-4">
                  {[
                    { patient: 'John Doe', date: '2025-01-04', medication: 'Amoxicillin 500mg' },
                    { patient: 'Jane Smith', date: '2025-01-03', medication: 'Ibuprofen 400mg' },
                    { patient: 'Mike Johnson', date: '2025-01-02', medication: 'Omeprazole 20mg' },
                  ].map((prescription, index) => (
                    <div key={index} className="border-l-4 border-green-500 bg-white p-4 shadow rounded-r-lg">
                      <div className="flex justify-between items-center">
                        <div>
